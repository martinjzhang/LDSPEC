...
# for i_rep in {0..4}
# do
# EFF_FILE=/n/groups/price/martin/WES_analysis/toy_1K/sanity_rep${i_rep}.eff.gz
# PREFIX_OUT=/n/groups/price/martin/WES_analysis/toy_1K/sanity_rep${i_rep}
...
for i_rep in {0..4}
do
PHEN_FILE=/n/groups/price/martin/WES_analysis/toy_1K/sanity_rep${i_rep}.phen
PREFIX_OUT=/n/groups/price/martin/WES_analysis/toy_1K/sanity_rep${i_rep}
