...
# # get_snp_block
# PREFIX_OUT=/n/groups/price/martin/LDSPEC_data/UKBimp_rep287K_MAF001_chimp/ukb_imp_v3
...
# # compute_ld (chr1: 116 files)
# for i_line in {1..2}
# # for i_line in {3..116}
# do 
# PREFIX_OUT=/n/scratch/users/j/jz286/imp_geno_rep287K_MAF001_chimp.ldspec_ld_1e7/ukb_imp_v3_chimp
# SNP_RANGE=$( head -n $i_line "/n/groups/price/martin/LDSPEC_data/UKBimp_rep287K_MAF001_chimp/ukb_imp_v3.snp_range.txt" | tail -1 )

# # Initial: sbatch -p short -t 00-6:00 -n 1 -c 1 --mem=16000
# # Second: sbatch -p short -t 00-12:00 -n 1 -c 1 --mem=24000
# sbatch -p medium -t 00-24:00 -n 1 -c 1 --mem=16000 --open-mode=truncate -o $PREFIX_OUT.${SNP_RANGE}.compute_ld.sbatch.log --wrap " \
# python3 /home/jz286/WES_analysis/LDSPEC/CLI_ldspec.py\
#     --job compute_ld\
#     --pgen_file $PGEN_FILE\
#     --snp_range $SNP_RANGE\
...
do
SNP_RANGE=$( head -n $i_line '/n/groups/price/martin/LDSPEC_data/UKBimp_rep287K_MAF001_chimp/ukb_imp_v3.snp_range.txt' | tail -1 )
LD_FILE=/n/scratch/users/j/jz286/imp_geno_rep287K_MAF001_chimp.ldspec_ld_1e7/ukb_imp_v3_chimp.${SNP_RANGE}_ld.npz

ANNOT_FILE=/home/jz286/WES_analysis/LDSPEC/experiments/job.analysis_imp_geno_chimp/reg_annot_file/reg_annot_file.rep287K.prox_gene_fct_all_ld.txt
PREFIX_OUT=/n/scratch/users/j/jz286/imp_geno_rep287K_chimp.score/ukb_imp_v3
    
sbatch -p short -t 0-2:00 -n 1 -c 1 --mem=32000 --open-mode=truncate -o ${PREFIX_OUT}.${SNP_RANGE}.compute_score.sbatch.log --wrap " \
python3 /home/jz286/WES_analysis/LDSPEC/CLI_ldspec.py\
    --job compute_score\
    --pgen_file $PGEN_FILE\
    --ld_file $LD_FILE\
...
# for i_line in {1..76}
# do 
# ANNOT_FILE=$( head -n $i_line "/home/jz286/WES_analysis/LDSPEC/experiments/job.analysis_imp_geno_chimp/reg_annot_file/reg_annot_file.ss50K.prox_gene_fct_all_ld.txt" | tail -1 )
# PREFIX_OUT=$ANNOT_FILE
# LD_FILE=/n/scratch/users/j/jz286/imp_geno_ss50K_chimp.ldspec_ld_1e7/ukb_imp_v3_chimp.${SNP_RANGE}_ld.npz
