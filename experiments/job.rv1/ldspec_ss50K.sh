...
# # get_snp_block
# PREFIX_OUT=/n/groups/price/martin/LDSPEC_data/UKBimp_ss50K_MAF001_chimp/ukb_imp_v3
...
# for i_line in {3..116}
do 
PREFIX_OUT=/n/scratch/users/j/jz286/imp_geno_ss50K_chimp.ldspec_ld_1e7/ukb_imp_v3_chimp
SNP_RANGE=$( head -n $i_line "/n/groups/price/martin/LDSPEC_data/UKBimp_ss50K_MAF001_chimp/ukb_imp_v3.snp_range.txt" | tail -1 )
SNP_RANGE=$( head -n $i_line "/n/groups/price/martin/LDSPEC_data/UKBimp_ss50K_MAF001_chimp/ukb_imp_v3.snp_range.uf.txt" | tail -1 )

# Initial: sbatch -p short -t 00-6:00 -n 1 -c 1 --mem=16000
# Second: sbatch -p short -t 00-12:00 -n 1 -c 1 --mem=24000
sbatch -p short -t 00-12:00 -n 1 -c 1 --mem=24000 --open-mode=truncate -o $PREFIX_OUT.${SNP_RANGE}.compute_ld.sbatch.log --wrap " \
python3 /home/jz286/WES_analysis/LDSPEC/CLI_ldspec.py\
    --job compute_ld\
    --pgen_file $PGEN_FILE\
    --snp_range $SNP_RANGE\
...
# PREFIX_OUT=/n/scratch/users/j/jz286/imp_geno_ss50K_chimp.score/ukb_imp_v3
...
# PREFIX_OUT=/n/groups/price/martin/LDSPEC_data/UKBimp_ss50K_MAF001_chimp/baseline_sp
