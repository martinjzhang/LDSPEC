...
PHEN_FILE=/n/groups/price/martin/LDSPEC_data/UKBB_trait_ss50K/${TRAIT}.resid.phen
PREFIX_OUT=/n/groups/price/martin/LDSPEC_data/UKBimp_ss50K_MAF001_chimp/sumstats/${TRAIT}
