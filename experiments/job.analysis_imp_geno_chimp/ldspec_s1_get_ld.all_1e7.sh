...
# for i_line in {4..1492}
for i_line in {118..1491}
do 
PREFIX_OUT=/n/scratch3/users/j/jz286/imp_geno_chimp.ldspec_ld_1e7/ukb_imp_v3_chimp
SNP_RANGE=$( head -n $i_line "/n/groups/price/martin/LDSPEC_data/UKBimp_337K_MAF001/ukb_imp_v3.snp_range.txt" | tail -1 )
