...
# for CHROM in 22
do
PGEN_FILE=/n/scratch/users/j/jz286/imp_geno_chimp/ukb_imp_chr${CHROM}_v3_chimp
# LD_FILE=/n/scratch3/users/j/jz286/imp_geno_chimp.gdreg_ld_1e7/ukb_imp_v3_chimp.@_ld.npz
LD_FILE=/n/groups/price/UKBiobank/insample_ld/ld_files/ukb_imp_v3_chimp.@_ld.npz
...
# OUT_PATH=/n/groups/price/martin/LDSPEC_data/UKBimp_337K_MAF001_chimp/pannot_basic/prox_0_100_ld_high_pos
...
# OUT_PATH=/n/groups/price/martin/LDSPEC_data/UKBimp_337K_MAF001_chimp/pannot_basic/prox_0_100_ld_high_neg
# sbatch -p short -t 0-06:00 -n 1 -c 1 --mem=16000 --open-mode=truncate -o $OUT_PATH/chr${CHROM}.sbatch.log --wrap " \
# python3 /home/jz286/WES_analysis/LDSPEC/CLI_pannot_basic.py \
#     --pgen_file $PGEN_FILE\
#     --ld_file $LD_FILE\
...
# OUT_PATH=/n/groups/price/martin/LDSPEC_data/UKBimp_337K_MAF001_chimp/pannot_basic/prox_0_1000_ld_high_pos
# sbatch -p short -t 0-06:00 -n 1 -c 1 --mem=16000 --open-mode=truncate -o $OUT_PATH/chr${CHROM}.sbatch.log --wrap " \
# python3 /home/jz286/WES_analysis/LDSPEC/CLI_pannot_basic.py \
#     --pgen_file $PGEN_FILE\
#     --ld_file $LD_FILE\
...
# OUT_PATH=/n/groups/price/martin/LDSPEC_data/UKBimp_337K_MAF001_chimp/pannot_basic/prox_0_1000_ld_high_neg
# sbatch -p short -t 0-06:00 -n 1 -c 1 --mem=16000 --open-mode=truncate -o $OUT_PATH/chr${CHROM}.sbatch.log --wrap " \
# python3 /home/jz286/WES_analysis/LDSPEC/CLI_pannot_basic.py \
#     --pgen_file $PGEN_FILE\
#     --ld_file $LD_FILE\
...
OUT_PATH=/n/groups/price/martin/LDSPEC_data/UKBimp_337K_MAF001_chimp/pannot_basic/prox_100_1000_ld_high_pos
sbatch -p short -t 0-06:00 -n 1 -c 1 --mem=16000 --open-mode=truncate -o $OUT_PATH/chr${CHROM}.sbatch.log --wrap " \
python3 /home/jz286/WES_analysis/LDSPEC/CLI_pannot_basic.py \
    --pgen_file $PGEN_FILE\
    --ld_file $LD_FILE\
...
OUT_PATH=/n/groups/price/martin/LDSPEC_data/UKBimp_337K_MAF001_chimp/pannot_basic/prox_100_1000_ld_high_neg
sbatch -p short -t 0-06:00 -n 1 -c 1 --mem=16000 --open-mode=truncate -o $OUT_PATH/chr${CHROM}.sbatch.log --wrap " \
python3 /home/jz286/WES_analysis/LDSPEC/CLI_pannot_basic.py \
    --pgen_file $PGEN_FILE\
    --ld_file $LD_FILE\
