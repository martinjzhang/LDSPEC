...
# common & lf, pos-LD
OUT_PATH=/n/groups/price/martin/LDSPEC_data/UKBimp_337K_MAF001_chimp/pannot_fct/baseline_0_${DIST_UB}_ld_high_pos
...
# common & lf, neg-LD
OUT_PATH=/n/groups/price/martin/LDSPEC_data/UKBimp_337K_MAF001_chimp/pannot_fct/baseline_0_${DIST_UB}_ld_high_neg
[ -d $OUT_PATH ] || mkdir $OUT_PATH
sbatch -p short -t 0-12:00 -n 1 -c 1 --mem=64000 --open-mode=truncate -o $OUT_PATH/chr${CHROM}.sbatch.log --wrap " \
python3 /home/jz286/WES_analysis/LDSPEC/CLI_pannot_fct.py \
    --pgen_file $PGEN_FILE\
