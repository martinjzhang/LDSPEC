...
SCORE_FILE=/n/groups/price/martin/data_GDREG/toy_10K/gdreg_file_score/toy_10K.@_score.tsv.gz
SUMSTATS_FILE=/n/groups/price/martin/data_GDREG/toy_10K/trait_simu_debug/${TRAIT}.sumstats.gz
PREFIX_OUT=/n/groups/price/martin/data_GDREG/toy_10K/gdreg_res_simu_debug/${TRAIT}
